...
The section-headers has information about how the executable is divided into sections - what part of executable is what section. Without section-headers, all this information is lost. Even with that information lost, we should be able to run it. Let us delate all the section-headers in *code1*.
